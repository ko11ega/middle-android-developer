...
/*
**PrefDelegate
Необходимо реализовать делегат для получения значений примитивов (Boolean, String, Float, Int, Long)
из SharedPreferences
+3
Реализуй делегат PrefDelegate<T>(private val defaultValue: T) : ReadWriteProperty<PrefManager, T?>
(ru.skillbranch.skillarticles.data.delegates.PrefDelegate) возвращающий значений примитивов
(Boolean, String, Float, Int, Long)
