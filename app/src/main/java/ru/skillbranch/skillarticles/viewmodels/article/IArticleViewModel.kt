...
interface IArticleViewModel {
     ...
     */
    //fun getArticleContent(): LiveData<List<MarkdownElement>?> //TODO

    /**
     * Получение краткой информации о статье из базы данных
     */
    //fun getArticleData(): LiveData<ArticleData?> //TODO

    /**
     * Получение пользовательской информации о статье из базы данных
     */
    //fun getArticlePersonalInfo(): LiveData<ArticlePersonalInfo?> //TODO
